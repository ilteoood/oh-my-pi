		...
		<div className="border-t border-separator px-4 py-3 bg-surface shrink-0">
			<div className="flex items-center gap-2 max-w-5xl mx-auto">
				<textarea
					...
					disabled={!connected}
					rows={1}
					className="flex-1 resize-none rounded-xl border border-[var(--color-border)] bg-default px-4 py-3 text-sm focus:outline-none focus:border-[var(--color-accent)] transition-colors disabled:opacity-50 max-h-[200px] field-sizing-content"
				/>
